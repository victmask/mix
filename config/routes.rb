Shoppik::Application.routes.draw do
  ...
  match '/booker'=> 'home#booker'
  match '/bookerxml'=> 'home#booker_xml'
  match '/validator'=> 'home#validator'
  match '/zip_code_validator' => 'home#zip_code_validator'
  match '/stocks'=> 'home#stocks'
  match '/stocks_picker' => 'home#stocks_picker'
  match '/newsfeeder'=> 'home#news_feeder'
  match '/newsfeederxml'=> 'home#news_feeder_xml'
